...
# Resources
 ...
 - [Add P-values and Significance Levels to ggplots] an article on creating 
   publication ready plots using ggpubr
 - [Create colorful graphs in R] an article on creating colorful ggplots using
   RColorBrewer and plotly
 - [Sampling, Data Management and Visualization] UNL Course led by Dr. Drew Tyre
...
[Create colorful graphs in R]: https://moderndata.plot.ly/create-colorful-graphs-in-r-with-rcolorbrewer-and-plotly/

...
Once you have installed [R], we should verify that you have the correct version.
 ...
 2. Enter the following in the R console after the `>`    
        ...
        R.version.string == "R version 3.5.2 (2018-12-20)"
...
`IntroR_2019-master/` with the folowing structure:
...
```{r, eval = FALSE}
install.packages(c("dplyr", "ggplot2", "plotrix"), repos = "https://cran.rstudio.com")
```
...
[Workshop Materials]: https://github.com/everhartlab/IntroR_2019/archive/master.zip

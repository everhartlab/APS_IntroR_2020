...
everything up to date, UBC's [STAT545] page is an excellent resource.
 ...
 - (Once you've installed R), install packages "[dplyr]", "[ggplot2]", "[plotrix]", and "[RColorBrewer]"
...
`APS_IntroR_2019-master/` with the folowing structure:
...
```{r, eval = FALSE}
install.packages(c("dplyr", "ggplot2", "plotrix", "RColorBrewer"), repos = "https://cran.rstudio.com")
```
...
[Workshop Materials]: https://github.com/everhartlab/APS_IntroR_2019/archive/master.zip

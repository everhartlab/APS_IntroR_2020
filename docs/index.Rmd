...
An introduction to R for plant pathologists written by Dr. Sydney E. Everhart, Nikita Gambhir, and Dr.Zhian N. Kamvar.
...
hours introducing plant pathologists to the basics of R by using an example
of fungicide trial data. 
